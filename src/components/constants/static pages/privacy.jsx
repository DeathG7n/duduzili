            ...
            <PBody>
                ...
                <MainBody>
                    ...
                    <Sections>
                        ...
                        <p>This privacy policy covers Duduzili concerns about your personal identifiable information that we collect when you use the online services. By using the Duduzili App and or website you accept the terms of this privacy policy. This privacy policy applies to all of our services unless specified otherwise</p>
                    </Sections>
                    <Sections>
                    ...
                    <Sections>
                        ...
                        <p>We may collect personal information from you when you do any of the following on our app and or website:
                            <ol>
                    ...
                    <Sections>
                        ...
                        <p>When we collect and process personal information, and while we retain this information, we will protect it within commercially acceptable means to prevent loss and theft, as well as unauthorized access, disclosure, copying, use, or modification. Although we will do our best to protect the personal information you provide to us, we advise that no method of electronic transmission or storage is 100% secure, and no one can guarantee absolute data security. We will comply with laws applicable to us in respect of any data breach. You are responsible for selecting any password and its overall security strength, ensuring the security of your own information within the bounds of our services.</p>
                    </Sections>
                    <Sections>
                    ...
                    <Sections>
                        ...
                        <p>We won’t share your personal or contact details with anyone for any reason whatsoever.</p>
                    </Sections>
                    <Sections>
                    ...
                    <Sections>
                        <h5>LIMITS OF OUR POLICY</h5>
                        <p>Our apps and website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices.</p>
                    </Sections>
                    <Sections>
                        <h5>CHANGES TO THIS POLICY</h5>
                        <p>At our discretion, we may change our privacy policy to reflect updates to our business processes, current acceptable practices, or legislative or regulatory changes. If we decide to change this privacy policy, we will post the changes here at the same link by which you are accessing this privacy policy. If required by law, we will get your permission or give you the opportunity to opt in to or opt out of, as applicable, any new uses of your personal information.</p>
                    </Sections>
                    <Sections>
                        <h5>CONTACT US</h5>
                        <p>For any questions or concerns regarding your privacy, you may contact us using the following details: privacy@duduzili.com</p>
                    </Sections>
                    <Sections>
                        <h5></h5>
                        <p></p>
